 ...
 * @author denil
 */
public class TelaBuscarUsuarios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblBuscarUsuarios = new javax.swing.JTable();
        ...
        tblBuscarUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblBuscarUsuarios);
        if (tblBuscarUsuarios.getColumnModel().getColumnCount() > 0) {
            tblBuscarUsuarios.getColumnModel().getColumn(0).setMaxWidth(75);
            tblBuscarUsuarios.getColumnModel().getColumn(2).setMinWidth(160);
            tblBuscarUsuarios.getColumnModel().getColumn(2).setMaxWidth(160);
            tblBuscarUsuarios.getColumnModel().getColumn(3).setMaxWidth(75);
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            List<Usuario> usuarios = usuario_repositorio.Buscar(filtro);
            
        preencherTabela(usuarios);
    
        } catch (ErroValidacaoException ex) {
            Logger.getLogger(TelaBuscarUsuarios.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnBuscarActionPerformed

    public void preencherTabela(List<Usuario> lista){
        ...
        for(Usuario usuario : lista){            
            ...
            linha.add(usuario.getId());
            linha.add(usuario.getNome());
            linha.add(usuario.getCPF());
            linha.add(usuario.getSexo());
            
            modelo.addRow(linha);
        }
        
        tblBuscarUsuarios.setModel(modelo);
    ...
    private javax.swing.JTable tblBuscarUsuarios;
